  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      beats.forEach((beat, index) => {
        ...
        const leaveBackTween = gsap.fromTo(
          text.children,
          { y: 0, opacity: 1 },
          {
            ...
            >
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center'>
                ...
                <div className='text-center lg:text-left max-w-prose'>
                  <span
                    className={`inline-block text-sm uppercase tracking-widest mb-4 font-mono ${
                      beat.color === 'primary'
                        ? 'text-primary'
                        : beat.color === 'accent'
                          ? 'text-accent'
                        ...
                        <div className='space-y-4'>
                          ...
                          <div className='p-4 bg-card rounded-lg border border-border'>
                            <div className='text-sm font-medium mb-2'>
                              <InlineFractionalExpression
                                expression={PRODUCT_FIXTURE.task.question}
                              />
                            </div>
                            <div className='text-sm text-text-secondary'>
                              ...
                              <span className='font-mono text-alert'>
                                <InlineFractionalExpression
                                  expression={PRODUCT_FIXTURE.answer.submitted}
                                />
                              </span>
                            </div>
                          </div>
                          ...
                          <div className='space-y-2'>
                            {PRODUCT_FIXTURE.patternExamples.map((example) => (
                              <div
                                ...
                                className='p-3 bg-card rounded border border-border text-xs'
                              >

  ...
  privaatsus: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Töötlejad (GDPR artikkel 28): LuxVPS (Luxembourg) — veebimajutus; Cloudflare Inc. (USA) — CDN, DDoS kaitse, e-posti saatmine; Slack (Dublin, Iirimaa) — pilootregistreerimise teavitused. Registreerimisvormi andmed (kooli nimi, kontaktisiku nimi, roll, e-post, telefon, klassirühmade arv) edastatakse vormi saatmisel Slacki teavitustena (töötleja ja lepinguosaline: Slacki avalike täiendavate tingimuste kohaselt on ELi/EMP klientide lepinguosaline Slack Technologies Limited, Dublin; andmete asukoht: Slacki pilv, vaikimisi USA, andmeresidentsuse seade sõltub tööruumi plaanist; rahvusvahelise edastuse alus: standardlepingu klauslid (SCCs, GDPR artikli 46(2)(c)) ning asjakohasel juhul EU-USA Data Privacy Framework; säilitusaeg: Slacki tööruumi säilitusreeglite kohaselt; MATx eemaldab pilootteated pärast piloodi lõppu; andmetöötlusleping: Slack Customer Data Processing Addendum — slack.com/trust/compliance/privacy). Rahvusvahelised edastused (Cloudflare): Standard Contractual Clauses (SCCs, EL-i komisjoni heakskiidetud standardlepingutingimused) + EU-USA Data Privacy Framework (täiendav kaitse). Cloudflare DPA ja allatöötlejate nimekiri: cloudflare.com/cloudflare-customer-dpa ja cloudflare.com/gdpr/subprocessors. Andmeid ei müüda ega edastata turunduseesmärgil kolmandatele isikutele. Õiguslik kohustus: võime avaldada andmeid Eesti õiguskaitseasutustele kohustusliku õigusnormi alusel (GDPR artikkel 6(1)(c)).',
      },
      {
